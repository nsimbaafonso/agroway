<section class="w-full h-screen relative overflow-hidden bg-slate-950 bg-cover bg-center bg-no-repeat group"
    style="background-image: url('{{ asset('img/contato.jpg') }}');">
    ...
    <div class="relative z-20 flex items-center justify-center h-full px-6 text-center">
        <div class="max-w-4xl space-y-6">
            ...
            <h1 class="hero-static-anim text-4xl md:text-6xl font-bold text-white leading-[1.2] tracking-tight">
                Vamos cultivar uma <em class="text-yellow-400 font-bold not-italic">parceria</em> de sucesso
            </h1>

            <p
                class="hero-static-anim max-w-2xl mx-auto text-base md:text-xl text-slate-300/90 font-light leading-relaxed">
                Dúvidas, sugestões ou interesse em fazer negócios? Nossa equipe está pronta <br class="hidden md:block">
                para ouvir você e conectar suas necessidades às soluções da Agroway.
            </p>
...
@push('styles')
    <style>
        ...
        /* Mantenha o nth-child(4) se houver um quarto elemento animado no futuro */
